document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadShifts() {
        ...
        Promise.all([
            fetch(`${API_BASE}api/shifts?calendar_id=${calendarId}&start=${start}&end=${end}`).then(res => res.json()),
            fetch(`${API_BASE}api/day-notes?calendar_id=${calendarId}&start=${start}&end=${end}`).then(res => res.json())
        ])
    ...
    function createShiftFromTemplate(templateId, calendarId, dateStr, tempId) {
        fetch(`${API_BASE}api/shifts/from-template`, {
            method: 'POST',
    ...
    function deleteShift(shiftId) {
        ...
        fetch(`${API_BASE}api/shifts/${shiftId}`, { method: 'DELETE' })
            .then(res => {
